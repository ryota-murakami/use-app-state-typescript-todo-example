...
const Item: React.FC<Props> = ({ todo }) => {
  ...
  useEffect(() => {
    // For fucus input element when double clicks text label. fix this // For fucus input element when double clicks text label. fix this https://github.com/laststance/create-react-app-typescript-todo-example-2020/issues/50
